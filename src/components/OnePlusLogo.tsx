...
export const OnePlusLogo: React.FC<OnePlusLogoProps> = ({ size = 28, className = '' }) => {
  return (
    ...
    >
      <defs>
        <linearGradient id="opInAppRedGrad" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <rect width="512" height="512" rx="112" fill="url(#opInAppRedGrad)" />
      ...
      {/* Legally-safe Fan Edition Pill Badge (Crisp Vector Paths) */}
